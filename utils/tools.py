...
def convert_to_m3u(first_channel_name=None):
    ...
    if os.path.exists(user_final_file):
        with open(user_final_file, "r", encoding="utf-8") as file:
            m3u_output = '#EXTM3U x-tvg-url="https://epg.internetprotocoltelevision.top/epg"\n'
            current_group = None
            for line in file:
                ...
                if trimmed_line != "":
                    if "#genre#" in trimmed_line:
                        ...
                        m3u_output += f'#EXTINF:-1 tvg-id="{processed_channel_name}" tvg-name="{processed_channel_name}" tvg-logo="http://logo.z271.com/{processed_channel_name}.png"'
                        if current_group:
